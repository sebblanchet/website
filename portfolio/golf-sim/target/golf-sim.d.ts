...
export interface InitOutput {
  ...
  readonly closure1261_externref_shim: (a: number, b: number, c: any) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h6b657c330253c890: (a: number, b: number) => void;
  readonly closure5537_externref_shim: (a: number, b: number, c: any, d: any) => void;
